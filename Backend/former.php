...
<div class="container-fluid">
	...
	<table class="table table-hover table-responsive-md table-striped table-bordered" width="100%">
	  ...
	  <tbody>
<?php
		$query = "SELECT * FROM team WHERE member='former' ";
    $team = mysqli_query($connection,$query);
    $tc = mysqli_num_rows($team);
    $per_page = 5;
    $pages = ceil($tc/$per_page);
	if (isset($_GET['page'])) {
		$page = $_GET['page'];
...
<?php
	if ($page==1) {
     ...
     <a class="page-link" href="former.php?page='.$new.'">Previous</a>
    </li>';
	}
	...
	while ($i<=$pages) {
		...
		echo '<li class="page-item"><a class="page-link" href="former.php?page='.$i.'">'.$i.'</a></li>';
		$i++;
	}
	if ($page==$pages) {
		echo '<li class="page-item disabled">
     <a class="page-link" href="#" tabindex="-1">Next</a>
		...
		$new = $page + 1;
		echo '<li class="page-item">
     <a class="page-link" href="former.php?page='.$new.'">Next</a>
    </li>';
	}
